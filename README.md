...
3. **💡 주제 기반 순수 창작 모드 (Topic-Based Deep Creation)**:
   - 외부 기사 복붙 없이 [포스팅 주제], [핵심 포인트/키워드], [특별 유의사항] 입력만으로 100% 독창적인 새 글 자동 완성.
   - 기사 원문 가공 모드와 탭 하나로 자유롭게 전환 가능.
